...
export default function AIStatsPanel() {
    ...
    return (
        <div className="flex flex-col h-full bg-neutral-900/10 backdrop-blur-sm rounded-xl border border-white/5 overflow-hidden">
            <div className="flex items-center justify-between p-2.5 border-b border-white/5 bg-transparent">
                <h3 className="text-[10px] font-medium text-neutral-500 uppercase tracking-widest flex items-center gap-2">
            ...
            <div className="p-3 space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2">
                    <div className="bg-white/5 p-2 rounded-lg border border-white/5">
                        <div className="text-[8px] text-neutral-600 uppercase font-bold mb-1 flex items-center gap-1 tracking-wider">
                ...
                {aiStats.lastRequest && (
                    <div className="bg-white/5 rounded-lg border border-white/5 p-2.5">
                        <div className="text-[9px] text-neutral-600 uppercase font-bold mb-2 tracking-wider">Last Request</div>

                        <div className="space-y-1.5 text-[10px] font-mono">
                            <div className="flex justify-between items-center opacity-70">
                                <span className="text-neutral-500">Agent</span>
                                <span className="text-neutral-400 bg-white/5 px-1.5 py-0.5 rounded border border-white/5">{aiStats.lastRequest.agent}</span>
                            </div>
                            <div className="flex justify-between items-center opacity-70">
